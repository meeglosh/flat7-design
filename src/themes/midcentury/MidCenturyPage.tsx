...
const PROJECTS = [
  ...
  { id: '05', name: 'SPASynth',    cat: 'Audio Software · VST/AU',  url: '/spasynth/',               accent: 'teal',    thumb: '/thumbnails/midcentury/spasynth.png',
  ...
  { id: '06', name: 'Decathlon',   cat: 'E-Commerce · Web & App',  url: '/decathlon/',                         accent: 'teal',    thumb: '/thumbnails/midcentury/decathlon.png',
