...
const PROJECTS = [
  ...
  { id: '07', name: 'Decathlon',   cat: 'E-Commerce · Web & App',  url: '/decathlon/',                         accent: 'teal',    thumb: '/thumbnails/midcentury/decathlon.png',
  ...
  { id: '08', name: 'RenoRun',     cat: 'Construction Tech · Web & App', url: '/renorun/',                     accent: 'mustard', thumb: '/thumbnails/midcentury/renorun.png',
