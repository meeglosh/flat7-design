...
const PROJECTS = [
  ...
  { name: 'Woltspace',   cat: 'AI Infra',      url: '/woltspace/',                color: '#885511', initials: 'Ws', thumb: '/thumbnails/myspace/woltspace.png' },
  ...
  { name: 'Estateably',  cat: 'LegalTech',     url: '/estateably/',                          color: '#554400', initials: 'Es', thumb: '/thumbnails/myspace/estateably.png' },
